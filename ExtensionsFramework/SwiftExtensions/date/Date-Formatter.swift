...
public extension Date {
    ...
    static func parseISO8601String(_ isoStringDate: Any?, isoType: ISO8601Type = .full) -> Date?  {
    ...
    func toString(format dateFormat: String, calendar: Calendar = Calendar.current) -> String? {
    ...
    func toString(template templateFormat: String, locale: Locale = Locale.current, calendar: Calendar = Calendar.current) -> String? {
